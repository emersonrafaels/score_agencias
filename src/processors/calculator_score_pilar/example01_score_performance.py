...
def main_execute_score_performance():
    ...
    df_aa = load_data_auto(Path(dir_root_performance,
                                "AA",
                                "BASE_SCORE_AA.xlsx"))
    df_ab = load_data_auto(Path(dir_root_performance,
                                "AB",
                                "BASE_SCORE_AB.xlsx"))
    df_infra_civil = load_data_auto(Path(dir_root_performance,
                                         "INFRA_CIVIL",
    ...
    save_data_auto(
        ...
        file_path=Path(dir_root,
                       "data/data_pilar/PERFORMANCE",
                       "BASE_SCORE_TEMA_PERFORMANCE.xlsx"),
        index=False,
    )
