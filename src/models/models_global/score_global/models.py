...
Este módulo define as classes para detalhes de score e cálculo base o score glbal,
...
class ScoreDetails(BaseModel):
    ...
    Attributes:
        ...
        weight (float): Peso aplicado ao score durante o cálculo do score score_global.
    """
...
class BaseScore:
    """
    Classe base para cálculo do score score_global com base em detalhes fornecidos.
    ...
    def __init__(self, details: ScoreDetails):
        ...
        self.farol_column = details.farol_column
    ...
    def weighted_score(self):
        ...
        """
        self.dataframe["SCORE_GLOBAL"] = self.dataframe[self.score_column] * self.weight
