...
def generate_dataframe_score_view():
    ...
    df.to_excel(r"C:\Users\Emerson\Desktop\Itaú\Comunidade Infra de Canais Físicos\Projetos\IBS 360\data\performance\INFRA_CIVIL\INFRA_CIVIL_01_09_2024.xlsx", index=None)
